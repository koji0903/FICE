...
/* [FromXML] Generated by VerilogToXML 1.4.6 at 2013-02-01 13:13:45 */
...
module TOP_EVA (clk, rst, D, Q1, Q2, DOUT, peri_o, AD_O, P80, dummy1, dummy2, CapOut, X1, X2, BG2ADSEL, 
    ...
    wire connect_1718;
    wire test_wire;
    wire FMakeWire_cspf_wrapper_FMAIN_FCLK;
    ...
    CSPF_wrapper cspf_wrapper (.Q(Q2), .D_Bus_Out(D_Bus), .test_clk(test_clk), .connect_bus_1718(connect_bus_1718), 
        ...
        .FMakeWire_cspf_ocd_SVSTOP(FMakeWire_cspf_wrapper_cspf_ocd_SVSTOP), .FMAIN_FCLK(FMakeWire_cspf_wrapper_FMAIN_FCLK), 
        .test_wire(test_wire), .connect_1718(connect_1718), .FMakeWire_cspf_mc200_CON_BUS1(FMakeWire_cspf_wrapper_cspf_mc200_CON_BUS1), 
        .FMakeWire_cspf_mc200_CON_BUS0(FMakeWire_cspf_wrapper_cspf_mc200_CON_BUS0), .cibc_ce0(cibc_ce0), 
        .FMakeWire_cspf_add_ff_clk_1777(FMakeWire_add_ff_clk_1777), .FMakeWire_cspf_add_ff_clk_bus_1777(FMakeWire_add_ff_clk_bus_1777[2:0]), 
    ...
    pericore pericore (.rst_res_n(rst_res_n), .peri_o(peri_o), .AD_O(AD_O), .SVSTOP(SVSTOP), .cap_out(cap_out), 
        ...
        .FMakeWire_cspf_wrapper_FMAIN_FCLK(FMakeWire_cspf_wrapper_FMAIN_FCLK), .FMakeWire_add_ff_RESB(rst_res_n), 
        .FMakeWire_add_ff_VIMDS1(FMakeWire_cspf_wrapper_cspf_bus_add_ff_VIMDS1), .FMakeWire_add_ff_VIMDS0(FMakeWire_cspf_wrapper_cspf_bus_add_ff_VIMDS0));
...
module pericore (rst_res_n, peri_o, bg2adsel, AD_O, SVSTOP, cap_out, a1, a0, FF3_O, FMakeWire_svmodif_SVSTOPICE, 
    FMakeWire_cspf_wrapper_FMAIN_FCLK, FMakeWire_add_ff_RESB, FMakeWire_add_ff_VIMDS1, FMakeWire_add_ff_VIMDS0);
    ...
    input FMakeWire_cspf_wrapper_FMAIN_FCLK;
    wire FMakeWire_cspf_wrapper_FMAIN_FCLK;
    ...
    ConnectA connectA (.I(FMakeWire_cspf_wrapper_FMAIN_FCLK));
    ConnectB connectB (.I(FMakeWire_cspf_wrapper_FMAIN_FCLK));
endmodule 
...
module CSPF_wrapper (D, Q, D_Bus_Out, test_clk, test_wire, connect_1718, connect_bus_1718, cibc_ce0, 
    ...
    FMAIN_FCLK, FMakeWire_cspf_mc200_CON_BUS1, FMakeWire_cspf_mc200_CON_BUS0, FMakeWire_cspf_add_ff_clk_1777, 
    FMakeWire_cspf_add_ff_clk_bus_1777, FMakeWire_add_ff_CLK60MHZ, FMakeWire_cspf_mc200_add_ff2_PUONOUT, 
    FMakeWire_ice_top_SYSRSOUTB, FMakeWire_cspf_mc200_add_ff2_clk, FMakeWire_cspf_mc200_add_ff2_CLK60M, 
    FMakeWire_cspf_bus_add_ff_VIMDS1, FMakeWire_cspf_bus_add_ff_VIMDS0);
    ...
    CSPF cspf (.Q(Q), .D_Bus_Out(D_Bus_Out), .test_clk(test_clk), .connect_bus_1718(connect_bus_1718), 
        ...
        .DADATA_Term(DADATA_Term[1:0]), .FMakeWire_da_FCLK(FMakeWire_da_FCLK), .test_wire(test_wire), 
        .connect_1718(connect_1718), .FMakeWire_mc200_CON_BUS1(FMakeWire_cspf_mc200_CON_BUS1), .FMakeWire_mc200_CON_BUS0(FMakeWire_cspf_mc200_CON_BUS0), 
        .cibc_ce0(cibc_ce0), .FMakeWire_add_ff_clk_1777(FMakeWire_cspf_add_ff_clk_1777), .FMakeWire_add_ff_clk_bus_1777(FMakeWire_cspf_add_ff_clk_bus_1777[2:0]), 
        .cspf_Q3(cspf_Q3), .FMakeWire_mc200_add_ff2_PUONOUT(FMakeWire_cspf_mc200_add_ff2_PUONOUT), .FMakeWire_mc200_add_ff2_clk(FMakeWire_cspf_mc200_add_ff2_clk), 
        .FMakeWire_mc200_add_ff2_CLK60M(FMakeWire_cspf_mc200_add_ff2_CLK60M), .FMakeWire_bus_add_ff_VIMDS1(FMakeWire_cspf_bus_add_ff_VIMDS1), 
        .FMakeWire_bus_add_ff_VIMDS0(FMakeWire_cspf_bus_add_ff_VIMDS0));
    flash_code flash_code (.CE0(cibc_ce0), .DOUT(DOUT), .A0(addr[0]), .A1(addr[1]), .A2(addr[2]), .bg2adsel(bg2adsel), 
        .mod_scanen(mod_scanen), .iceck30m(iceck30m), .BG2ADSEL(BG2ADSEL), .SCANCLK(1'b0), .ICECK60M(FMakeWire_add_ff_CLK60MHZ), 
        .rst_sysrsout_n(FMakeWire_ice_top_SYSRSOUTB), .rst_res_n(rst_res_n));
    da_ICE da (.da_data(DADATA_Term[1:0]), .FMAIN_FCLK(FMAIN_FCLK), .FCLK(FMakeWire_da_FCLK));
endmodule 
...
module CSPF (D, Q, D_Bus_Out, test_clk, test_wire, connect_1718, connect_bus_1718, cibc_ce0, addr, rst_res_n, 
    ...
    RESETB, FMakeWire_svmodif_SVSTOPICE, FMakeWire_ocd_SVSTOP, FMakeWire_da_FCLK, FMakeWire_mc200_CON_BUS1, 
    FMakeWire_mc200_CON_BUS0, FMakeWire_add_ff_clk_1777, FMakeWire_add_ff_clk_bus_1777, FMakeWire_mc200_add_ff2_PUONOUT, 
    FMakeWire_mc200_add_ff2_clk, FMakeWire_mc200_add_ff2_CLK60M, FMakeWire_bus_add_ff_VIMDS1, FMakeWire_bus_add_ff_VIMDS0);
    ...
    CPU cpu (.dummy(dummy1), .SVSTOP(FMakeWire_svmodif_SVSTOPICE), .FCLK(FMakeWire_da_FCLK), .EMEMRAMCLK(FMakeWire_da_FCLK));
...
module MC200 (D, Q, test_clk, test_wire, wire_1718, CON_BUS1, CON_BUS0, reset_b, P80, DADATA, VIMDS1, 
    ...
    port7 port7 (.O(out), .test_clk(test_clk), .test_wire(test_wire), .CON_BUS1(CON_BUS1), .CON_BUS0(CON_BUS0), 
        .wire_1718(wire_1718), .VIMDS1(VIMDS1), .VIMDS0(VIMDS0), .PTTL(PTTL07), .rstb(RESETB), .DADATA(DADATA_Term));
    port8_ICE port8 (.SPAD(P80), .PTTL(P80), .PTTL2(PTTL08), .rst_b(RESETB), .SCANCLK(1'b0));
