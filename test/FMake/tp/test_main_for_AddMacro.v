...
module test (CLK, RST, SEL, DIN, DIN2, DOUT, SELOUT, IO_PORT1, IO_PORT2, Port_add_macro_In_A1, Port_add_macro_Out_B1, 
    Port_add_macro_Inout_C1, Port_add_macro_Inout_C2);
    wire FMakeWire_add_macro_Out_B3;
    wire [3:0] FMakeWire_add_macro_Out_B2;
    inout [3:0] Port_add_macro_Inout_C2;
    wire [3:0] Port_add_macro_Inout_C2;
    inout Port_add_macro_Inout_C1;
    wire Port_add_macro_Inout_C1;
    output Port_add_macro_Out_B1;
    wire Port_add_macro_Out_B1;
    input Port_add_macro_In_A1;
    wire Port_add_macro_In_A1;
    input CLK, CLK2;
    input RST;
    input SEL;
    input [3:0] DIN, DIN2;
    ...
    SubMod sub0 (.a(1'b1), .d(SEL_w), .c(wire001), .b(FMakeWire_add_macro_Out_B2[3:0]), .aaa(FMakeWire_add_macro_Out_B3));
    ...
    ADD_MODULE add_macro (.In_A1(Port_add_macro_In_A1), .In_A3(1'b0), .In_A4(11'b11111111111), .Out_B1(Port_add_macro_Out_B1), 
        .Inout_C1(Port_add_macro_Inout_C1), .Inout_C2(Port_add_macro_Inout_C2[3:0]), .In_A2(wire001), 
        .Out_B4(), .Out_B2(FMakeWire_add_macro_Out_B2[3:0]), .Out_B3(FMakeWire_add_macro_Out_B3));
endmodule 
