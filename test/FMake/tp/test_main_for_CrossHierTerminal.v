...
module test (CLK, RST, SEL, DIN, DIN2, DOUT, SELOUT, IO_PORT1, IO_PORT2, Port_sub0_drive_change_c1_a, 
    Port_sub0_drive_change_c1_b);
    output Port_sub0_drive_change_c1_b;
    wire Port_sub0_drive_change_c1_b;
    input Port_sub0_drive_change_c1_a;
    wire Port_sub0_drive_change_c1_a;
    input CLK, CLK2;
    input RST;
    input SEL;
    input [3:0] DIN, DIN2;
    ...
    SubMod sub0 (.a(1'b1), .b(wire002), .c(wire001), .d(SEL_w), .Port_sub0_drive_change_c1_a(Port_sub0_drive_change_c1_a), 
        .Port_sub0_drive_change_c1_b(Port_sub0_drive_change_c1_b));
...
module SubMod (aaa, b, c, d, Port_sub0_drive_change_c1_a, Port_sub0_drive_change_c1_b);
    output Port_sub0_drive_change_c1_b;
    wire Port_sub0_drive_change_c1_b;
    input Port_sub0_drive_change_c1_a;
    wire Port_sub0_drive_change_c1_a;
    ...
    DriveChangeC drive_change_c1 (.a(Port_sub0_drive_change_c1_a), .b(Port_sub0_drive_change_c1_b));
